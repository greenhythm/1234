...
/**
 * 退选课程Servlet (Drop Course Controller)
 */
@WebServlet("/drop")
public class DropServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean success = enrollmentService.dropCourse(userId, courseId);
            if (success) {
                response.getWriter().write("{\"success\":true,\"message\":\"退选成功\",\"courseId\":" + courseId + "}");
            } else {
                response.getWriter().write("{\"success\":false,\"message\":\"退选失败\",\"courseId\":" + courseId + "}");
            }
